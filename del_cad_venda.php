...
if($qtdeprod1 && !$qtdeprod2) {
	...
	if(!$resultado){
	echo "<h2>Error deleting sale</h2>";
	echo "<a href='del_venda.php' target='principal'><h1>Back</h1></a>";
	}
	else
	{
	echo "<h2>Sale successfully removed!</h2>";	
	echo "<a href='del_venda.php' target='principal'><h1>Back</h1></a>";
	}
}
...
{
	echo "<h2>Please enter a code</h2>";
	echo "<a href='del_venda.php' target='principal'><h1>Back</h1></a>";
}
?>
</body>
