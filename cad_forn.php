...
echo "<a href='novo_forn.php' target='principal'><h1>Back</h1></a>";
}
else
{
echo "<h2>Successfully Included!</h2>";	
echo "<a href='novo_forn.php' target='principal'><h1>New Supplier</h1></a>";
}
?>
</body>
</html>